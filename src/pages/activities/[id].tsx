    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#050505] text-white">
        <div className="text-center p-8 max-w-md bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md">
          ...
          <h2 className="text-xl font-bold mb-2">Invalid Activity ID</h2>
          <p className="text-gray-400">The requested activity identifier is invalid.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#050505] text-white">
        <div className="text-center p-8 max-w-md bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md">
          ...
          <p className="text-gray-400">The activity ID format is incorrect.</p>
        </div>
      </div>
    );
  }
