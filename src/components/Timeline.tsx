  ...
  return (
    <section className="py-20 relative overflow-hidden aurora-bg">
      <div className="layout-container relative z-10 max-w-5xl">
        {content.title && (
          <h2
            className={`text-4xl md:text-5xl font-bold mb-16 text-white drop-shadow-lg animate-slide-in-up ${textAlignClass}`}
          >
        ...
        <div className={`flex flex-col ${itemsAlignClass} space-y-12`}>
          {timelineItems.map((item, idx) => (
            <div
              key={idx}
              className={`group animate-slide-in-up w-full max-w-3xl ${textAlignClass}`}
